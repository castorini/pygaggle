...
# All rights reserved.
#
# This source code is licensed under the license https://github.com/facebookresearch/FiD/blob/main/LICENSE
...
class FiDT5(transformers.T5ForConditionalGeneration):
    ...
    def generate(self, input_ids, attention_mask, max_length):
        self.encoder.n_passages = input_ids.size(1)
        kwars = dict()
        kwars['attention_mask'] = attention_mask.view(attention_mask.size(0), -1)
        updated_kwars = super()._prepare_encoder_decoder_kwargs_for_generation(input_ids.view(input_ids.size(0), -1),kwars)
        base_encoder_outputs = BaseModelOutput()
        base_encoder_outputs['last_hidden_state'] = updated_kwars['encoder_outputs'][0]
